...
const deleteCompositions = async(params) => {
    ...
    const query = `DELETE FROM compositions WHERE id in (${params.ids})`
    ...
    return {
        result: 'successful',
        message: 'compositions purged',
        ids: params.ids
    }
}

module.exports = deleteCompositions
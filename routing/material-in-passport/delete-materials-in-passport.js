...
const deleteMaterialsInPassport = async(params) => {
    ...
    const query = `DELETE FROM mat_in_pas WHERE id in (${params.ids})`
    ...
    return {
        result: 'successful',
        message: 'Materials In passports purged',
        ids: params.ids
    }
}

module.exports = deleteMaterialsInPassport